  ...
  const tipsData: TipData[] = [
    {
      ...
      description: 'Tudo o que você precisa saber para começar a correr de forma segura e eficiente. Desde a escolha do tênis até seu primeiro treino.',
      badge: 'Iniciante',
      icon: 'lightning',
      rating: 4,
      readTime: '10 min',
    ...
    },
    {
      ...
      description: 'Descubra quais equipamentos realmente fazem a diferença na sua corrida. Guia completo de acessórios, tênis e roupas.',
      badge: 'Equipamento',
      icon: 'shopping',
      rating: 4,
      readTime: '15 min',
    ...
    },
    {
      ...
      description: 'Como manter a motivação, superar barreiras mentais e desenvolver a mentalidade de um corredor consistente.',
      badge: 'Psicologia',
      icon: 'lightbulb',
      rating: 4,
      readTime: '8 min',
    ...
    },
    {
      ...
      description: 'Estratégias eficazes para recuperação pós-treino, importância do sono e como evitar lesões por overtraining.',
      badge: 'Recuperação',
      icon: 'heart',
      rating: 4,
      readTime: '12 min',
    ...
    },
    {
      ...
      description: 'Plano completo de preparação para maratona, incluindo periodização, nutrição específica e estratégias de prova.',
      badge: 'Avançado',
      icon: 'chart',
      rating: 5,
      readTime: '20 min',
    ...
    },
    {
      ...
      description: 'Dicas essenciais para correr no calor, frio, chuva e altitude. Adaptações necessárias para cada condição climática.',
      badge: 'Clima',
      icon: 'cloud',
      rating: 4,
      readTime: '6 min',
    ...
    },
    {
      ...
      description: 'Guia completo sobre alimentação para corredores: o que comer antes, durante e após os treinos e provas.',
      badge: 'Nutrição',
      icon: 'trash',
      rating: 4,
      readTime: '14 min',
    ...
    },
    {
      ...
      description: 'Aprenda a técnica correta de corrida: postura, pisada, cadência e respiração para maior eficiência e menos lesões.',
      badge: 'Técnica',
      icon: 'clock',
      rating: 4,
      readTime: '18 min',
