        ...
        <section className="py-16 bg-[#CFF350] dark:bg-letx-green-dark transition-colors duration-300">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              ...
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <svg className="w-4 h-4 text-gray-300 dark:text-gray-600 mr-1" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">10 min</span>
                  </div>
                  ...
                  <button className="w-full bg-letx-blue text-white py-3 rounded-lg hover:bg-letx-blue-dark transition-colors duration-300 font-semibold">
                    Ler Guia
                  </button>
                </div>
              </article>
              ...
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">15 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
              ...
              {/* Card 3 */}
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                <div className="bg-gradient-to-br from-letx-orange to-letx-green-water h-48 flex items-center justify-center relative">
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/20 backdrop-blur-sm text-letx-green-dark dark:text-letx-neon px-3 py-1 rounded-full text-sm font-medium">
                      Psicologia
                    </span>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">8 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
              ...
              {/* Card 4 */}
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                <div className="bg-gradient-to-br from-letx-neon to-letx-blue h-48 flex items-center justify-center relative">
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/20 backdrop-blur-sm text-letx-green-dark dark:text-letx-neon px-3 py-1 rounded-full text-sm font-medium">
                      Recuperação
                    </span>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">12 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
              ...
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">20 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
              ...
              {/* Card 6 */}
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                <div className="bg-gradient-to-br from-letx-blue-dark to-letx-neon h-48 flex items-center justify-center relative">
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/20 backdrop-blur-sm text-letx-green-dark dark:text-letx-neon px-3 py-1 rounded-full text-sm font-medium">
                      Clima
                    </span>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">6 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
                    Corrida em Diferentes Climas
                  </h3>
                  <p className="text-gray-600 dark:text-letx-green-water mb-4 line-clamp-3">
              ...
              {/* Card 7 */}
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                <div className="bg-gradient-to-br from-letx-orange/80 to-letx-blue h-48 flex items-center justify-center relative">
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/20 backdrop-blur-sm text-letx-green-dark dark:text-letx-neon px-3 py-1 rounded-full text-sm font-medium">
                      Nutrição
                    </span>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">14 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
                    Nutrição Esportiva
                  </h3>
              ...
              {/* Card 8 */}
              <article className="bg-letx-white dark:bg-letx-blue-dark rounded-2xl shadow-lg overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border border-letx-green-water/20">
                <div className="bg-gradient-to-br from-letx-green-water/80 to-letx-green-dark h-48 flex items-center justify-center relative">
                  <div className="absolute top-4 left-4">
                    <span className="bg-white/20 backdrop-blur-sm text-letx-green-dark dark:text-letx-neon px-3 py-1 rounded-full text-sm font-medium">
                      Técnica
                    </span>
                ...
                <div className="p-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-letx-green-water ml-2">18 min</span>
                  </div>
                  <h3 className="text-xl font-bold text-letx-green-dark dark:text-letx-neon mb-3">
                    Técnica de Corrida
                  </h3>
