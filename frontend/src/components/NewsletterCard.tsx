    ...
    <div className="bg-letx-orange p-8 h-full flex flex-col justify-center min-h-[350px]">
      <div className="space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#472a3c] text-letx-white font-bold py-3 px-4 rounded-lg hover:bg-[#412134] transition-colors"
          >
            Assinar
          </button>
        </form>
        ...
        <div className="flex items-center justify-center space-x-6">
          <span className="text-white">siga-nos</span>
          <a href="#" className="text-white hover:text-[#CFF350] transition-colors">
